...
Note: To visualize intermediate results for each processing step (e.g., semantic masks, depth maps, layered RGBA images), run the scripts located in the respective folders: `2d_to_3d/` and `parallax_crolling/`.

## Results 
### 2D-to-3D Pop-Out Rendering
The demonstration videos are available in [2D-to-3D Demo](https://github.com/user-attachments/assets/6642abeb-981a-4b7b-9ba8-5b71dec42d78).
